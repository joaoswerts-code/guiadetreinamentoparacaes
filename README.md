...
7. Ao acessar, **lembre da barra final** (`/`) na URL — `https://seu-usuario.github.io/guiadetreinamentoparacaes/`.

A página identifica automaticamente em qual subpasta foi hospedada.

## Conteúdo

- `index.html` — página principal (quiz + página de vendas).
- `404.html` — cópia do index para SPA routing em URLs inexistentes.
...
- Os botões de compra só aparecem após **10 segundos** do vídeo assistidos. O desbloqueio fica salvo no navegador do visitante.
...
- O contador "X pessoas assistindo agora" e o total "Mais de 1.847 cães já treinados" são fictícios/decorativos e variam aos poucos.
- O scroll horizontal está bloqueado — o site só rola para cima e para baixo.
